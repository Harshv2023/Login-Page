...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: PzuVz6EbQTX_/css
    ...
    >
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <SearchsvgIcon
              className={classNames(projectcss.all, sty.svg__o87O0)}
              role={"img"}
            />
          ),
      ...
      <input
        ...
        className={classNames(projectcss.all, projectcss.input, sty.username, {
          [sty.username___focusVisibleWithin]: triggers.focusVisibleWithin_root,
          [sty.usernamecolor_dark]: hasVariant($state, "color", "dark"),
          [sty.usernameisDisabled]: hasVariant(
            $state,
            "isDisabled",
            "isDisabled"
          ),
          [sty.usernameshowStartIcon]: hasVariant(
            $state,
            "showStartIcon",
            "showStartIcon"
          )
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <ChecksvgIcon
              className={classNames(projectcss.all, sty.svg__aGd5C)}
              role={"img"}
            />
          ),
...
const PlasmicDescendants = {
  root: ["root", "startIconContainer", "username", "endIconContainer"],
